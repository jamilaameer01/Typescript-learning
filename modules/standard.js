...
async function standardCalculation() {
    ...
    while (run) {
        ...
        let value1 = answer.value1;
        let value2 = answer.value2;
        let operator = answer.operator;
        switch (operator) {
            case "+":
                console.log(`Answer of ${value1} + ${value2} is ${chalk.green.bold(value1 + value2)}`);
                break;
            case "-":
                console.log(`Answer of ${value1} - ${value2} is ${chalk.green.bold(value1 - value2)}`);
                break;
            case "x":
                console.log(`Answer of ${value1} x ${value2} is ${chalk.green.bold(value1 * value2)}`);
                break;
            case "*":
                console.log(`Answer of ${value1} * ${value2} is ${chalk.green.bold(value1 * value2)}`);
                break;
